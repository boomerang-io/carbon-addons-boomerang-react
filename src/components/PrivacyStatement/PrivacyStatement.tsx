...
function PrivacyStatement({
  ...
  return (
    <ComposedModal open className={`${prefix}--bmrg-privacy-statement-container`}>
      <ModalHeader
                ...
                <>
                  ...
                  <ModalBody>
                    <p className={`${prefix}--bmrg-privacy-statement-delete__desc`}>
                      ...
                      from our system and we will notify your team(s) that you are no longer a memeber of the platform.
