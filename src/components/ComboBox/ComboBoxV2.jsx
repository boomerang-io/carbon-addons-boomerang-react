...
export default class ComboBox extends React.Component {
  ...
  handleOnInputValueChange = (inputValue, { setHighlightedIndex }) => {
    ...
    setHighlightedIndex(onInputChange || shouldFilterItem ? 0 : findHighlightedIndex(this.props, inputValue));
  ...
  handleOnStateChange = (newState, { setHighlightedIndex }) => {
    if (Object.prototype.hasOwnProperty.call(newState, "inputValue")) {
      ...
      const items = this.filterItems(this.props.items, this.props.itemToString, inputValue);
      setHighlightedIndex(
