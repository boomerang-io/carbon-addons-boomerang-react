  ...
  return (
    ...
    >
      <defs>
        ...
        >
          <stop offset={0} stopColor="#fff" stopOpacity={0} />
          <stop offset={0.18} stopColor="#f9fbfd" stopOpacity={0.02} />
          <stop offset={0.34} stopColor="#e7eff6" stopOpacity={0.09} />
          <stop offset={0.49} stopColor="#c9daea" stopOpacity={0.21} />
          <stop offset={0.64} stopColor="#9ebed9" stopOpacity={0.38} />
          <stop offset={0.79} stopColor="#6799c3" stopOpacity={0.59} />
          <stop offset={0.93} stopColor="#256ca9" stopOpacity={0.85} />
          <stop offset={1} stopColor="#00539a" />
        </linearGradient>
        <style>
          {
      ...
      />
      <path stroke="#c1c7cd" strokeWidth={1.31} fill="none" strokeMiterlimit={10} d="M664.38 475.22L663.95.25" />
      <g id="prefix__Sign">
        <path className="prefix__cls-4" d="M928.36 55.17v64.59l126 72.69-.04-64.51-125.96-72.77z" />
        <path className="prefix__cls-5" d="M928.36 55.17l6.17-3.65 126.24 73.17-6.45 3.25-125.96-72.77z" />
        <path className="prefix__cls-6" d="M1054.32 127.94l6.45-3.25v62.44l-6.41 5.32-.04-64.51z" />
        <path className="prefix__cls-7" d="M933.33 64.35v52.21l115.8 66.84-.03-52.41-115.77-66.64z" />
        <path
      ...
      />
      <path className="prefix__cls-7" d="M890.04 147.76L686.69 265.71l-12.03-6.68 203.48-117.65 11.9 6.38z" />
      <path className="prefix__cls-16" d="M674.66 258.71l12.03 6.68.01 466.4-10.86-6.27-1.18-466.81z" />
      <path
      ...
      <g id="prefix__Planet">
        <path className="prefix__cls-20" d="M1096.24 355.46a77.72 77.72 0 11-76.64-134.91l76.64 43.6z" />
        <path d="M1096.24 264.15c0 29.51.1 89.57 0 89.62a77.72 77.72 0 01-78.59-134z" fill="#009d9a" />
      ...
      <g id="prefix__Rocket_Group" data-name="Rocket Group">
        ...
        <g id="prefix__Flames">
          ...
          />
          <path id="prefix__Flame" fill="#fa4d56" d="M995.65 475.09l-.01 6.01-4.81 2.77.93-2.68-6.41-.26 10.3-5.84z" />
        </g>
      </g>
      <path
        className="prefix__cls-14"
