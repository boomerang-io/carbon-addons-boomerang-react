...
import { Accordion, AccordionItem, InlineLoading, SideNavMenuItem, SkeletonPlaceholder,SkeletonText, SwitcherDivider } from 'carbon-components-react';
      ...
      <HeaderRightPanel
        content={
          <div className={`${prefix}--bmrg-header-teams__loading`}>
            <SkeletonPlaceholder className={`${prefix}--bmrg-header-team__skeleton`} />
            <SkeletonPlaceholder className={`${prefix}--bmrg-header-team__skeleton`} />
            <SkeletonPlaceholder className={`${prefix}--bmrg-header-team__skeleton`} />
            <SkeletonPlaceholder className={`${prefix}--bmrg-header-team__skeleton`} />
            <SkeletonPlaceholder className={`${prefix}--bmrg-header-team__skeleton`} />
