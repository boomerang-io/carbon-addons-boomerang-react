            ...
            <>
              ...
              <ModalBody>
                <div className={`${prefix}--bmrg-feedback`}>
                  <p>Share your thoughts and ideas on what we can do to improve the {this.props.platformName} platform and our Onboarding process.</p>
                  <p>
                    To submit your idea, visit our portal at
                    {" " /* We need to force a space before the link tag */}
                    <a href={this.props.sendIdeasUrl}
                      target="_blank"
                  ...
                  <p>
                    For now, you must have an {this.props.platformName} email address and you will need to register with a password during your first visit.
                  </p>
                  <p>
