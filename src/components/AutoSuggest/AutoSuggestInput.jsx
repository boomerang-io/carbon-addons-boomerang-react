...
const getSuggestions = (values, value) => {
  ...
  return inputLength === 0 ? [] : values.filter((option) => option.toLowerCase().slice(0, inputLength) === inputValue);
};
    ...
    return (
      <div className={`${prefix}--bmrg-auto-suggest`}>
        <AutoSuggest
          ...
          renderInputComponent={children ? (inputProps) => children(inputProps) : renderInputComponent || undefined}
