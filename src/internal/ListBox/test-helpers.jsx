...
export const findMenuNode = (wrapper) => wrapper.find(`.${prefix}--list-box__menu`);
export const findMenuItemNode = (wrapper, index) => wrapper.find("ListBoxMenuItem").at(index);
export const findMenuIconNode = (wrapper) => wrapper.find(`.${prefix}--list-box__menu-icon`);
export const findFieldNode = (wrapper) => wrapper.find(`.${prefix}--list-box__field`);
export const findComboboxNode = (wrapper) => wrapper.find(`.${prefix}--list-box[role="combobox"]`);
export const findPopupNode = (wrapper) => wrapper.find('[aria-haspopup="listbox"]').hostNodes();
